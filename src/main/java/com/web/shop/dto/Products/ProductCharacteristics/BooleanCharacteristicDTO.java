...
public class BooleanCharacteristicDTO implements Serializable {
    ...
    public ProductCharacteristicDTO getProductCharacteristicDTO() {
        return productCharacteristic;
    }

    public void setProductCharacteristicDTO(ProductCharacteristicDTO productCharacteristicDTO) {
    ...
    public String toString() {
        return "BooleanCharacteristicDTO{" +
                "id=" + id +
